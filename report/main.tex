...
\begin{table}[h]
    ...
    \begin{tabular}{|c|c|c|}
    \hline
    \multicolumn{1}{|l|}{STT} & Mô hình                                                                           & MAE             \\ \hline
    1                         & Sử dụng 22 đặc trưng (Tất cả ngoại trừ  CollegeTier, Degree)                      & 112176.27596763 \\ \hline
    2                         & Sử dụng 21 đặc trưng (Tất cả ngoại trừ 12\%, Quant, openess\_to\_exp)             & 111849.95116329 \\ \hline
    3                         & Sử dụng 17 đặc trưng (ngoại trừ từ MechanicalEngg đến hết trong bảng biểu đồ cột) & 110724.24861457 \\ \hline
    \end{tabular}%
    }
    \end{table}\\
    ...
    \begin{itemize}
        \item 
        \begin{flalign}
            & \text{Salary} = (-23438.408) \times \text{Gender} + (887.524) \times \text{10percentage} && \\
            \nonumber 
            & \quad + (971.041) \times \text{12percentage} + (-79706.706) \times \text{CollegeTier} && \\
            \nonumber 
            & \quad + (1689.069) \times \text{collegeGPA} + (148.766) \times \text{English} && \\
            \nonumber 
            & \quad + (132.912) \times \text{Logical} + (95.513) \times \text{Quant} && \\
            \nonumber 
            & \quad + (22104.286) \times \text{Domain} + (104.259) \times \text{ComputerProgramming} && \\
            \nonumber 
            & \quad + (-164.058) \times \text{ComputerScience} + (-20216.903) \times \text{conscientiousness} && \\
            \nonumber 
            & \quad + (16789.581) \times \text{agreeableness} + (5018.386) \times \text{extraversion} && \\
            \nonumber 
            & \quad + (-9649.493) \times \text{nueroticism} + (-6317.617) \times \text{openess\_to\_experience} &&
        \end{flalign}
